...
.adventure-islands {
	...
	text-align: center;
	border-radius: 40px;
	/* Bordas arredondadas para o container principal - MAIS ARREDONDADO */
	box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15);
	/* Sombra para destacá-lo - MAIS PROEMINENTE */
	position: relative;
	width: 100%;
...
.island-card:hover {
	...
	/* MAIS EFEITO NO HOVER */
	box-shadow: 0 15px 30px rgba(0, 0, 0, 0.25);
	border-color: var(--cor-primaria-acao); /* Borda fica azul ao hover */
}

.island-card .icon-wrapper {
	background: linear-gradient(45deg, var(--cor-primaria-acao),
		var(--cor-secundaria-acao));
	border-radius: 50%;
...
.island-card:hover .icon-wrapper {
	...
	background: linear-gradient(45deg, var(--cor-secundaria-acao),
		var(--cor-primaria-acao)); /* Inverte o degradê */
}

/* Cores de fundo dos ícones dos cards */
.island-card:nth-child(1) .icon-wrapper {
	background: linear-gradient(45deg, var(--cor-terciaria-acao), #FF66A3);
} /* Rosa */
.island-card:nth-child(2) .icon-wrapper {
	background: linear-gradient(45deg, var(--cor-secundaria-acao), #FFB800);
} /* Amarelo */
.island-card:nth-child(3) .icon-wrapper {
	background: linear-gradient(45deg, var(--cor-primaria-acao), #3399FF);
} /* Azul */
/* Card extra para demonstração, se quiser mais tarde */
.island-card:nth-child(4) .icon-wrapper {
	background: linear-gradient(45deg, #B388FF, #9966FF);
} /* Roxo */
.island-card h3 {
	font-family: var(--fonte-titulo);
...
.island-card .btn-explorar {
	...
	text-decoration: none;
	/* Gradiente sutil */
	background: linear-gradient(135deg, var(--cor-primaria-acao) 0%, #33AADD
		100%);
...
.island-card .btn-explorar:hover {
	...
	background: linear-gradient(135deg, #33AADD 0%, var(--cor-primaria-acao)
		100%); /* Inverte o gradiente */
}
...
/* ===========
        ...
        */
.hero-banner {
	background: linear-gradient(135deg, var(--cor-primaria-acao) 0%,
		var(--cor-roxo-divertido) 100%);
	color: var(--cor-texto-claro);
	padding: 6rem 5%;
	text-align: center;
	position: relative;
...
@
keyframes slideInUp {from { transform:translateY(50px);
	opacity: 0;
}
...
<body>
	...
	<header>
		...
		<nav class="nav-links-container">
			...
			<a href="SobreNosLogado.jsp" class="nav-link" id="aboutUsLink">
				...
				href="Historico/historicov1.jsp" class="nav-link" id="contactButton">
				Relatório </a>
		</nav>
	...
	<main>
		<section class="hero-banner">
			<h1>Conectando, Apoiando e Inspirando para um Mundo Mais
				Inclusivo.</h1>
			<p>Um espaço seguro e acolhedor para a comunidade autista e suas
				famílias, oferecendo ferramentas, atividades e uma rede de apoio
				mútuo.</p>
			<div class="cta-group">
				<a href="Atividades&Recursos.html" class="btn-primary"><i
					class="fas fa-compass"></i> Explorar emoções</a>
			</div>
		</section>

		<section class="welcome-section">
			<h2>Bem-vindos ao Calmamente!</h2>
			<p>Nossa missão é ser um farol de apoio e compreensão,
				proporcionando recursos valiosos e um ambiente onde todos se sintam
				vistos, ouvidos e valorizados. Acreditamos no poder da conexão e do
				conhecimento para transformar vidas.</p>
			<p>Aqui você encontrará ferramentas para o registro de emoções,
				atividades para o desenvolvimento de habilidades, artigos
				informativos e uma comunidade vibrante pronta para compartilhar
				experiências.</p>
		</section>
		...
		<section class="content-highlights">
			...
			<div class="island-container">
				<div class="island-card">
					...
					<p>Entenda e interprete suas emoções com nossa ferramenta. Um
						passo essencial para o autoconhecimento.</p>
					<a href="./Historico/historicov1.jsp" class="btn-explorar"><i
						class="fas fa-arrow-right"></i> Começar </a>
				</div>
				...
				<div class="island-card">
					...
					<p>Encontre atividades e dinâmicas que auxiliam no tratamento e
						na convivência com o autismo.</p>
					<a href="Atividades&Recursos.jsp" class="btn-explorar"><i
						class="fas fa-arrow-right"></i> Ler Mais</a>
				</div>
				...
				<div class="island-card">
					...
					<p>Venha explorar nosso projeto mais detalhadamente e descubra
						todas as suas incríveis possibilidades.</p>
					<a href="SobreNosLogado.jsp" class="btn-explorar"><i
						class="fas fa-arrow-right"></i> Participar</a>
				</div>

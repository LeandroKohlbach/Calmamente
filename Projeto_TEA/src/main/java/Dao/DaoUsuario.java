...
import java.sql.Date; // Certifique-se de que este import está presente se 'dt_nascimento' for java.sql.Date
...
public class DaoUsuario {
    ...
    public static Usuario insert(Usuario usuario) {
        try {
            ...
            // Removida a vírgula extra antes do parêntese de fechamento no SQL
            ...
            throw new RuntimeException(e.getMessage() + "usuario nao cadastrado");
        }
        return usuario;
    }

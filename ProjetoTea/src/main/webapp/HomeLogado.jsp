...
<body>
        ...
        <section class="adventure-islands" id="adventure-islands">
            ...
            <div class="island-container">
                ...
                <div class="island-card">
                    ...
                    <a href="./Historico/historicoCalendario.jsp" class="btn-explorar">
                        <i class="fas fa-book"></i> Ver Diário
                    </a>
                </div>
                <%-- <div class="island-card">
                    <div class="icon-wrapper"><i class="fas fa-gamepad"></i></div>
                    <h3>Mini-Jogos Divertidos</h3>
                    <p>Relaxe e se divirta com jogos simples e educativos que ajudam a clarear a mente.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Listener para o botão "Navegar Emoções"
            if (navigateEmotionsBtn) {
                navigateEmotionsBtn.addEventListener('click', function(event) {
                    ...
                    // Aumentado o tempo para 1.5 segundos para a animação ser mais perceptível
                    setTimeout(function() {
